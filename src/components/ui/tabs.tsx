...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn('inline-flex h-10 items-center justify-center rounded-lg bg-secondary/30 backdrop-blur-xl border border-border/30 p-1 text-muted-foreground', className)}
    {...props}
  />
))
